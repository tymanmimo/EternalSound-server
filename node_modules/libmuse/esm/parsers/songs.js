...
export function get_shuffle_and_radio_ids(item) {
    const shuffle = find_object_by_icon_name(j(item, MENU_ITEMS), "menuNavigationItemRenderer", "MUSIC_SHUFFLE");
    const radio = find_object_by_icon_name(j(item, MENU_ITEMS), "menuNavigationItemRenderer", "MIX");
    return {
        shuffleId: shuffle
