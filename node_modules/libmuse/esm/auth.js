...
import { use_proxy, wait } from "./util.js";
...
export class Authenticator extends EventTarget {
    ...
    async get_login_code() {
        const response = await this.client.request(use_proxy("https://www.youtube.com/o/oauth2/device/code"), {
            method: "post",
            data: {
    ...
    async load_token_with_code(...args) {
        ...
        while (!res || !res.refresh_token) {
            ...
            const response = await this.client.request(use_proxy("https://oauth2.googleapis.com/token"), {
                method: "post",
                data: {
                    client_id: CONSTANTS.CLIENT_ID,
    ...
    async get_token() {
        ...
        if (token.expires_date < new Date()) {
            const res = await this.client.request(use_proxy("https://oauth2.googleapis.com/token"), {
                method: "post",
                data: {
                    client_id: CONSTANTS.CLIENT_ID,
                    client_secret: CONSTANTS.CLIENT_SECRET,
